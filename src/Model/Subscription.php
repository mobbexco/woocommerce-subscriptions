...
class Subscription extends \Mobbex\WP\Subscriptions\Model\Model
{
    /** @var Helper */
    public $helper;
    ...
    public static function get_by_uid($uid)
    {
        ...
        return !empty($result[0]) ? new \Mobbex\WP\Subscriptions\Model\Subscription($result[0]['product_id']) : null;
    }
    ...
    {
        $subscription = new \Mobbex\WP\Subscriptions\Model\Subscription(
            $sub_options['post_id'],
