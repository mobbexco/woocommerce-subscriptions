...
class Subscriber extends \Mobbex\WP\Subscriptions\Model\Model
{
    ...
    {
        $subscription = \Mobbex\WP\Subscriptions\Model\Subscription::get_by_uid($this->subscription_uid); // Aca hay que revisar
    ...
    public static function get_by_uid($uid)
    {
        ...
        return !empty($result[0]) ? new \Mobbex\WP\Subscriptions\Model\Subscriber($result[0]['order_id']) : null;
    }
